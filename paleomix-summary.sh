...
for sample in $SAMPLES; do
	...
	hits_raw=$(awk -v sample=${sample} '$3 == sample && $4 ~ /hits_raw/ {print $5}' ${sumdir}${sample}.summary)
	...
	hits_unique=$(awk -v sample=${sample} '$3 == sample && $4 ~ /hits_unique/ {print $5}' ${sumdir}${sample}.summary)
